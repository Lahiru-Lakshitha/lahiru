...
export const portfolioItems: PortfolioItem[] = [
  ...
  {
    id: "video-1",
    title: "Restaurant Promo Reel – Social Media Short (Instagram)",
    image: "https://i.postimg.cc/mg75y5DY/Screenshot-2025-12-25-150436.png",
    videoUrl: "https://www.youtube.com/embed/FSInfgenFp0",
    description: "High-energy restaurant promo reel edited for social media platforms. Includes fast cuts, cinematic transitions, color grading, and rhythm-based editing to attract food lovers.",
  ...
  {
    id: "video-2",
    title: "Fashion Brand Promo Reel – Social Media Video (Instagram)",
    image: "https://i.postimg.cc/Ssx0V2gL/Screenshot-2025-12-25-170115.png",
    videoUrl: "https://www.youtube.com/embed/HvcuzbeHiHM",
    description: "A short-form promotional video created for a fashion brand to highlight clothing collections with a premium and stylish feel. The reel uses smooth camera movements, cinematic framing, and clean text overlays to communicate the brand message “Designed to Impress,” making it ideal for social media marketing and brand storytelling.",
    category: "video-editing",
    type: "video",
    showOnHomepage: false,
  },
